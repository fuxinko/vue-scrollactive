  ...
  return (function (t) {
    ...
    function (t, e) {
      ...
      t.exports = function (t, e, n, o) {
        ...
        if (t === e && n === o) return s;
        for (var i = r ? new Float32Array(11) : new Array(11), l = 0; l < 11; ++l)
          i[l] = a(0.1 * l, t, n);
        function u(e) {
          for (var r = 0, o = 1; 10 !== o && i[o] <= e; ++o) r += 0.1;
          --o;
          var s = r + 0.1 * ((e - i[o]) / (i[o + 1] - i[o])),
            l = c(s, t, n);
          return l >= 0.001
            ? (function (t, e, r, n) {
                for (var o = 0; o < 4; ++o) {
            ...
            : (function (t, e, r, n, o) {
                var i,
                  ...
                  s = 0;
                do {
                  (i = a((c = e + (r - e) / 2), n, o) - t) > 0 ? (r = c) : (e = c);
                } while (Math.abs(i) > 1e-7 && ++s < 10);
                return c;
              })(e, r, r + 0.1, t, n);
        }
        return function (t) {
          return 0 === t ? 0 : 1 === t ? 1 : a(u(t), e, o);
        };
      };
    },
    function (t, e) {
    ...
    function (t, e, r) {
      var n = (function (t) {
        ...
        var m = (h.prototype = u.prototype = Object.create(d));
        function y(t) {
    ...
    function (t, e, r) {
      ...
      var o = r(2),
        ...
        m = (function () {
          function t(e) {
            d()(this, t);
            var r = window;
            e && (r = document.querySelector(e) || window), (this.container = r);
          }
          return (
            v()(t, [
              {
                ...
                value: function (t) {
                  (this.scrollListenerCallback = t), this.container.addEventListener('scroll', t);
                },
              },
              {
              ...
              },
              {
                key: 'scrollTo',
                value: function (t, e) {
                  return this.container.scrollTo(t, e);
                },
              },
              {
                key: 'getOffsetTop',
        ...
        y = function (t, e) {
          return [].forEach.call(t, e);
        },
        g = function (t) {
          return decodeURI(t.substr(1));
        },
        w = function (t) {
        ...
        b = function (t) {
          return t.dataset.sectionSelector
            ? t.dataset.sectionSelector
            : t.hash
            ? '#'.concat(g(t.hash))
            : '';
        };
      var x = (function (t, e, r, n, o, i, a, c) {
        var s,
      ...
      })(
        {
          ...
          computed: {
            ...
            scrollContainer: function () {
              return new m(this.scrollContainerSelector);
            },
          },
          mounted: function () {
          ...
          methods: {
            ...
            initScrollactiveItems: function () {
              var t = this,
                e = this.$el.querySelectorAll('.scrollactive-item'),
                r = [];
              y(e, function (t) {
                var e = document.querySelector(b(t));
                e && r.push({ section: e, menuElement: t });
              }),
                (this.items = r),
                this.clickToScroll
                  ? y(e, function (e) {
                      return e.addEventListener('click', t.onMenuItemClick);
                    })
                  : y(e, function (e) {
                      return e.removeEventListener('click', t.onMenuItemClick);
                    });
            },
            onScroll: function (t) {
              (this.currentItem = this.getItemInsideWindow()),
            ...
            getItemInsideWindow: function () {
              var t,
                e = this;
              return (
                y(this.items, function (r, n) {
                  var o = r.menuElement,
                    i = r.section,
                    a = 0 === n,
                    c = e.scrollContainer.getDistanceFromTop(),
                    s = e.getOffsetTop(i) - e.offset,
                    l = c >= s,
                    u = c < s + i.offsetHeight,
                    f = l && u;
                  a && e.highlightFirstItem && u && (t = o),
                    e.exact && f && (t = o),
                    !e.exact && l && (t = o);
                }),
                t
                    ...
                    for (;;)
                      switch ((r.prev = r.next)) {
                        ...
                        case 7:
                          return (
                            e.alwaysTrack ||
                              (e.scrollContainer.removeScrollListener(),
                              window.cancelAnimationFrame(e.scrollAnimationFrame),
                              e.removeActiveClass(),
                              n.classList.add(e.activeClass)),
                            (r.next = 10),
                            e.scrollTo(i)
                          );
                        case 10:
                          e.alwaysTrack ||
                            (e.scrollContainer.addScrollListener(e.onScroll),
                            (e.currentItem = n),
                            e.currentItem !== e.lastActiveItem &&
                              (e.$emit('itemchanged', t, e.currentItem, e.lastActiveItem),
                              (e.lastActiveItem = e.currentItem))),
                            e.modifyUrl &&
                              w(
                                (a = n).dataset.sectionSelector &&
                                  '#' === a.dataset.sectionSelector.substr(0, 1)
                                  ? a.dataset.sectionSelector
                                  : a.hash
                              );
                        case 12:
                        case 'end':
            ...
            scrollTo: function (t) {
              ...
              return new Promise(function (r) {
                var n = e.getOffsetTop(t),
                  o = e.scrollContainer.getDistanceFromTop(),
                  a = n - o,
                  c = e.bezierEasing.apply(e, i()(e.cubicBezierArray)),
                  s = null;
                window.requestAnimationFrame(function t(n) {
                  s || (s = n);
                  var i = n - s,
                    l = i / e.duration;
                  i >= e.duration && (i = e.duration), l >= 1 && (l = 1);
            ...
            getOffsetTop: function (t) {
              ...
              return (
                this.scrollContainer.getOffsetTop() && (e -= this.scrollContainer.getOffsetTop()), e
              );
            },
            removeActiveClass: function () {
              var t = this;
              y(this.items, function (e) {
                e.menuElement.classList.remove(t.activeClass);
              });
            },
            scrollToHashElement: function () {
              ...
              if (e) {
                var r = document.getElementById(g(e));
                r &&
                  ...
                  setTimeout(function () {
                    ...
                    t.scrollContainer.scrollTo(0, n), w(e);
                  }, 0));
              }
            },
          },
      ...
      x.options.__file = 'src/scrollactive.vue';
      var S = x.exports,
        E = {
          install: function (t) {
            E.install.installed || t.component('scrollactive', S);
          },
        };
      'undefined' != typeof window && window.Vue && E.install(window.Vue);
      e.default = E;
    },
  ]);
});
